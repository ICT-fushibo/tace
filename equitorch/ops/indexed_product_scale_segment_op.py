...
def indexed_outer_scale_segment(
    input1, 
    input2, 
    scale, 
    index1=None, 
...
def indexed_inner_scale_segment(
    input1, 
    input2, 
    scale, 
    index1=None, 
...
def indexed_vecmat_scale_segment(
    input1, 
    input2, 
    scale, 
    index1=None, 
...
def indexed_vecsca_scale_segment(
    input1, 
    input2, 
    scale, 
    index1=None, 
