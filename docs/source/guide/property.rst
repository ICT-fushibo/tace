...
3. External Electric and Magnetic Fields
----------------------------------------

External electric fields have been fully tested.
...
If you require magnetic field support, please contact us.
...
4. Atomic Virials and Atomic Stresses
-------------------------------------
...
6. Computational Level (``level``)
----------------------------------

The ``level`` attribute is treated as a **dataset label** used to distinguish
different levels of computational accuracy (e.g., different exchange-correlation functionals).
