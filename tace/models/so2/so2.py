...
# class uvSO2MElementLinear(torch.nn.Module):
#     """
#     Based on https://github.com/atomicarchitects/equiformer_v3/blob/main/experimental/models/equiformer_v3/so2_ops.py
#     Original Paper: https://proceedings.mlr.press/v202/passaro23a.html
#     """
...
#     def forward(self, x, y, concat_outputs=True):
#         # [batch, 2, -1]
#         if self.weight_type == 'w1_w2':
#             return self.w1_w2_forward(x, y, concat_outputs)
#         elif self.weight_type == 'w1_w1':
#             return self.w1_w1_forward(x, y, concat_outputs)
#         else:
#             return self.w1_forward(x, y, concat_outputs)
    
#     def w1_w2_forward(self, x, y, concat_outputs=True) -> Union[tuple[torch.Tensor, torch.Tensor], torch.Tensor]:
...
#     def w1_w1_forward(self, x, y, concat_outputs=True):
#         xr = x.narrow(1, 0, 1)
#         xi = x.narrow(1, 1, 1)
#         # yr = W(xr - xi)
#         # yi = W(xi + xr)
...
#     def w1_forward(self, x, y, concat_outputs=True):
#         x = self.fc(x, y)
#         if concat_outputs:
#             return x
#         return (x.narrow(1, 0, 1), x.narrow(1, 1, 1))
...
# class uvSO2ElementLinear(torch.nn.Module):
#     """
#     Based on https://github.com/atomicarchitects/equiformer_v3/blob/main/experimental/models/equiformer_v3/so2_ops.py
#     Original Paper: https://proceedings.mlr.press/v202/passaro23a.html
#     """
...
#         self.m0_rlinear = torchElementLinear(
#             self.num_channel_in * self.num_components_in[0], 
#             self.num_channel_out * self.num_components_out[0], 
#             bias=True,
#             num_elements=num_elements,
...
#             offset = offset + 2 * self.num_components_in[m]
#             xm = xm.reshape(B, 2, -1)
#             xm = self.ms_clinear[m - 1](xm, y, concat_outputs=False)
#             xr, xi = xm[0], xm[1]
#             xr = xr.view(B, -1, Cout)
#             xi = xi.view(B, -1, Cout)
#             outputs.append(xr)
