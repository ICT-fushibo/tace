...
from .fused import O3ScatterTensorProduct, SO2EqtScatterTensorProduct, SO2ScatterTensorProduct
...
class EqtSO2Interaction(Interaction):
    """
    An interaction module based on Clebsch-Gordan tensor products (CGTP).
    ...
    def _setup(self) -> None:
        ...
        self.rejector = SO2EqtScatterTensorProduct(
            self.irreps_in,
            self.irreps_sh,
            self.irreps_out,
            l1l2=self.l1l2,
